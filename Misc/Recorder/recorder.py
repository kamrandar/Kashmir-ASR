...
for i in ['Male_North', 'Disgust', 'Joy', 'Fear', 'Suspense', 'Neutral', 'Sad']:
    try:
        os.mkdir(i)
    except:
        pass
...
popupMenu = tk.OptionMenu(root, emo, *{'Male_North':'Male_North', 'Disgust':'Disgust', 'Joy':'Joy', 'Fear':'Fear','Suspense':'Suspense', 'Neutral':'Neutral', 'Sad':'Sad'})
